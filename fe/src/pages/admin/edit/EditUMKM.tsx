        ...
        <div className="max-w-4xl px-6 py-6 mx-auto">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6 p-6 bg-white border rounded-md shadow-md md:grid-cols-2">
                ...
                <div>
                    ...
                    <input name="time_open_close" value={form.time_open_close} onChange={handleChange} placeholder="Senin - Sabtu, 08:00 - 17:00" className="w-full p-2 border border-gray-200 rounded" />
                </div>
                <div>
