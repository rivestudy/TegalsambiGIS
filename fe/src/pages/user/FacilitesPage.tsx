...
const FacilitesPage = () => {
    return (
        <div className="bg-white">
            ...
            {/* Main Konten */}
            <motion.div className="max-w-screen-xl mx-auto px-4 pt-16 pb-16" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1, duration: 1 }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {penginapan.map((inap) => (
                        <Link to={`/wisata/${inap.id}`} key={inap.id}>
