                    ...
                    <div className="px-6 py-3 border rounded-full shadow-md bg-white/20 backdrop-blur-md border-white/30">
                        <nav>
                            <ol className="flex items-center space-x-2 text-sm font-semibold text-white">
                                ...
                                <li><Link to="/accommodation" className="transition duration-300 hover:text-orange-400">Akomodasi</Link></li>
                                <li className="text-gray-300">/</li>
                 ...
                 <div className="md:w-1/2">
                    ...
                    <div className="flex gap-4 p-2 mt-4 overflow-x-auto">
                        {imageList.map((img, index) => (
                            <img key={index} src={img} alt={`Thumbnail ${index + 1}`} onClick={() => setMainImage(img)} className={`w-20 h-20 rounded-md border-2 object-cover cursor-pointer transition duration-300 scale-95 hover:scale-100 ${mainImage === img ? "border-purple-500" : "border-transparent"}`} />
                        ))}
                    </div>
                </div>
                <div className="p-6 space-y-6 text-gray-800 border border-gray-200 shadow-xl md:w-1/2 bg-gradient-to-r from-purple-100 to-indigo-100 rounded-xl">
                     <div>
                        <h2 className="mb-2 font-semibold text-purple-900">Tentang Akomodasi</h2>
                     ...
                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-6">
                        ...
                        <div>
                         ...
                         <div>
                            <h3 className="font-semibold text-purple-900">Poin Menarik</h3>
