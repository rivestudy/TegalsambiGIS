...
const AttractionPage = () => {
    ...
    if (loading)
        return <div className="flex items-center justify-center h-screen">Memuat data wisata...</div>;
    if (error)
        return <div className="flex items-center justify-center h-screen text-red-500">{error}</div>;

    const filterByCategory = (cats: string[]) =>
        data.filter((item) => cats.includes(item.category));

    return (
        <div className="bg-white">
            <div
                className="relative h-[480px] bg-cover bg-center"
                style={{ backgroundImage: "url('/pantaitegalsambi2.webp')" }}
            >
                                ...
                                <Link to="/" className="flex items-center hover:text-orange-400">
                                    ...
                                    >
                                        <path
                                            ...
                                            d="M3 9.75L12 4l9 5.75V20a1 1 0 01-1 1h-5a1 1 0 01-1-1v-5H9v5a1 1 0 01-1 1H4a1 1 0 01-1-1V9.75z"
                                        />
                                    </svg>
                                    Landing Page
                                </Link>
                    ...
                    >
                        <div className="relative">
                            <input
                                ...
                                className="w-full py-2 pl-10 pr-4 text-gray-500 border border-gray-300 rounded-full shadow-lg"
                            />
