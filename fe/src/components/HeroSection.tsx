...
const HeroSection = ({
  ...
  <div className="relative h-[480px] bg-cover bg-center" style={{ backgroundImage: `url('${bgImage}')` }}>
    ...
    <motion.div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center text-white"
      ...
      <motion.div className="w-full max-w-md" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.8 }}>
        <div className="relative">
          <input type="text" placeholder={placeholder} className="w-full py-2 pl-10 pr-4 text-gray-500 border border-gray-300 rounded-full shadow-lg" />
